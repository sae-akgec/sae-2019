...
export class LandingService {
  ...
  headerThree(rootElem) {
    ...
    let Cow = function () {
      ...
      let bodyGeom = new THREE.BoxGeometry(100, 100, 100);
      let spotGeom = new THREE.BoxGeometry(20, 20, 20);
      let tailGeom = new THREE.BoxGeometry(10, 10, 30);
      tailGeom.applyMatrix(new THREE.Matrix4().makeTranslation(0, 0, -20));
      let faceGeom = new THREE.BoxGeometry(100, 100, 100);
      let ringGeom = new THREE.TorusGeometry(200, 3, 4, 4)
      let ringGeom2 = new THREE.TorusGeometry(50, 3, 4, 4)
    ...
    let Planet = function () {
      ...
      let colors = [0x000000, 0x6abc94, 0xee7351, 0xcd9b56, 0xf8f8f8];
      ...
      let geom = new THREE.BoxGeometry(s, s, s);
    ...
    function loop() {
      angleLegs += .2;
      let sin = Math.sin(angleLegs);
      let cos = Math.cos(angleLegs);
